<!--
 * @Description: file 管理用户列表
 * @Author: IMAGINE
 * @Date: 2021-03-20 12:21:55
 * @LastEditors: IMAGINE
 * @LastEditTime: 2021-05-11 20:33:56
-->
<template>
  <div class="MD">
    <div class="MDcontent">
      ...
      >
        ...
        <el-table-column prop="user_role" label="用户身份"> 
          <template>
            <el-tag
              type="danger"
              disable-transitions>管理员用户</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="option" label="操作" width="200"> 
          <template slot-scope="scope">
              ...
              size="mini"
              type="blue"
              @click="handleChange(scope.$index, scope.row)">转为客服</el-button>
            <el-button
              size="mini"
              type="danger"
