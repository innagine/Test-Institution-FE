...
<template>
  <div class="service-scope">
     <ul class="ul-1">
       <li @click="show(1)" ref="select1">生物扫描电镜（SEM）</li>
       <li @click="show(2)" ref="select2">生物透射电镜（TEM）</li>
       <li @click="show(3)" ref="select3">荧光定量PCR</li>
       <li @click="show(4)" ref="select4">流式细胞仪</li>
     </ul>
